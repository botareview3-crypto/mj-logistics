...
export const CATEGORY_ROOTS: CategoryRoot[] = [
  {
    ...
    systems: [
      ...
      },
      {
        ...
        name: 'Tires & Wheels',
        iconName: 'CircleDot',
        description: 'Passenger, SUV, and all-terrain tires, plus alloy and steel wheel rims.',
        ...
        subsystems: [
          {
            ...
            iconName: 'Circle',
            description: 'All-season and summer tires for sedans, hatchbacks, and compacts.',
            itemCount: 2650,
          ...
          },
          {
            ...
            name: 'SUV & 4x4 Tires',
            iconName: 'CircleDot',
            description: 'Highway, all-terrain, and mud-terrain tires for SUVs and pickups.',
            itemCount: 1380,
          ...
          },
          {
            ...
            name: 'Wheel Rims',
            iconName: 'Circle',
            description: 'Alloy and steel wheels in a range of sizes and bolt patterns.',
            itemCount: 640,
            image: 'https://images.unsplash.com/photo-1580274455191-1c62238fa333?auto=format&fit=crop&w=400&q=80',
          },
        ],
      },
    ],
  ...
  {
    id: 'stationery-equipment',
    name: 'Stationery & Equipment',
    description: 'Office stationery, printing supplies, and general business equipment.',
    systems: [
      {
        id: 'office-stationery',
        rootId: 'stationery-equipment',
        ...
        subsystems: [
          {
            ...
            systemId: 'business-equipment',
            name: 'Printers & Scanners',
            iconName: 'Package',
            description: 'Inkjet and laser printers, scanners, and toner cartridges.',
            itemCount: 85,
          ...
          },
          {
            ...
            iconName: 'Package',
            description: 'Keyboards, mice, monitor stands, and cables.',
            itemCount: 210,
            image: 'https://images.unsplash.com/photo-1497032628192-86f99bcd76bc?auto=format&fit=crop&w=400&q=80',
          },
          {
            ...
            iconName: 'Package',
            description: 'Desks, office chairs, and storage cabinets.',
            itemCount: 60,
            image: 'https://images.unsplash.com/photo-1497032628192-86f99bcd76bc?auto=format&fit=crop&w=400&q=80',
          },
        ],
